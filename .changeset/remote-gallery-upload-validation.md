...
Also fixes gallery entries that have both a key error (e.g. wrong directory) and a metadata error: previously only the metadata error was reported, now both are.

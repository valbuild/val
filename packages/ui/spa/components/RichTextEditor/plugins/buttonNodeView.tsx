  ...
  function openOverlay() {
    ...
    if (portal) {
      overlayContainer.className = [
        "fixed z-[60] rounded-md border border-border-primary",
      ...
      overlayContainer.className = [
        "absolute z-[60] rounded-md border border-border-primary",
        "bg-bg-primary p-1 shadow-lg",
      ].join(" ");
      overlayContainer.style.minWidth = "180px";
      overlayContainer.style.left = "0";
      overlayContainer.style.top = `${anchorEl.offsetHeight + 4}px`;

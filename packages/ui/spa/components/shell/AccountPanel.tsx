...
/**
 * The account and the workspace: who is signed in, the theme, auto save, the
 * branch, the deployment feed, and the links into Val Build.
 *
 * NOT the project's settings — those are content (`s.settings()`), they are
 * published like any other content, and they live in {@link SettingsPanel}
 * behind the cog in the rail. This panel is per-person and per-machine, which
 * is why it hangs off the account button at the FOOT of the rail rather than
 * being a destination.
 *

...
export function AutoGrowingTextarea(
  ...
  const className =
    "flex rounded-md m-1 border border-border-primary bg-bg-primary px-3 py-2 text-base file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-focus disabled:cursor-not-allowed disabled:opacity-50";
  return (
    <div className="grid">
      <textarea
        {...props}

...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-1.5 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-border-focus",
  {
    variants: {
      variant: {

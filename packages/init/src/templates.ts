...
import { s, c${isJavaScript ? "" : ", type t"} } from "${configImportPath}";
...
export const testSchema = s.object({
  ...
  // see the ValRichText component to see how to render this in your app
  richText: s.richtext({
  ...
  // see the ValImage component to see how to render this in your app
  image: s.image().optional(),
  // string enums: presents as a dropdown in the UI
  stringEnum: s.union(s.literal("lit-0"), s.literal("lit-1")),
  // raw strings disables the stega feature. It is useful for slugs and other data that might be processed in code (parsed or matching for equality...)
  slug: s.string().raw(),
...
${
  isJavaScript
    ? ""
    : `
// This is the type of the content. Use this to type props of components that use this content (partially or whole)

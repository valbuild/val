...
describe("enrichFileImageSourceWithRemote", () => {
  test("should enrich image source with metadata from images module", () => {
    ...
    const enrichedSource = enrichFileImageSourceWithRemote(source, testSchema);
  ...
  test("should enrich deeply nested schema with multiple images, files, records, arrays, unions, and richtext", () => {
    ...
    const productsModule = c.define(
      ...
      {
        "/public/val/products/widget.jpg": {
          width: 600,
          height: 400,
          mimeType: "image/jpeg",
          alt: "Widget product",
        },
        "/public/val/products/gadget.jpg": {
          width: 800,
          height: 600,
          mimeType: "image/jpeg",
          alt: "Gadget product",
        },
        "/public/val/products/inline-product.png": {
          width: 100,
          height: 100,
          mimeType: "image/png",
    ...
    const testModule = c.define("/content/deep-test.val.ts", deepSchema, {
      ...
      products: [
        {
          ...
          details: {
            ...
            gallery: [
              c.image("/public/val/products/widget.jpg"),
              c.image("/public/val/products/gadget.jpg"),
            ],
          },
        },
      ],
      ...
      contentBlocks: [
        ...
        },
        {
          ...
          productImage: c.image("/public/val/products/widget.jpg"),
        },
        {
          ...
          body: [
            {
              ...
              children: [
                ...
                {
                  tag: "img",
                  src: c.image("/public/val/products/inline-product.png"),
                },
              ],
            },
          ],
    ...
    const source = Internal.getSource(testModule);
    const enrichedSource = enrichFileImageSourceWithRemote(
      source,
      deepSchema,
    ) as typeof source;
    ...
    // Verify array -> object -> object -> array -> image
    ...
    const productBlock = enrichedSource.contentBlocks[1] as {
      type: "product";
      productImage: ReturnType<typeof c.image>;
    };
    ...
    // Verify richtext inline image in union
    ...
    expect(inlineImg.src).toEqual(
      c.image("/public/val/products/inline-product.png", {
        width: 100,
        height: 100,
        mimeType: "image/png",
        alt: "Inline product image",
